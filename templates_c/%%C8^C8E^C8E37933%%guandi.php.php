<?php /* Smarty version 2.6.6, created on 2015-08-11 04:14:20
         compiled from chouqian/guandi.php */ ?>
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="b1" style="table-layout:fixed;word-wrap:break-word;">
    <tbody><?php if (( isset ( $_REQUEST['act'] ) && $_REQUEST['act'] == 'jq' )): ?>
        <tr><td align="center" class="new"><img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/guandimg/<?php echo $this->_tpl_vars['gdlqid']; ?>
.gif"></td></tr><tr><td class="new"><A href="?m=3"><font color=red>点击这里返回抽签首页！</font></A> </td>
        </tr><?php else: ?>
        <tr><td align="center" class="new"><img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/gd2.gif" width="160" height="240"></td>
...
" title="首先请您心无杂念，然后点这里开始擲出聖杯"><img src=<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/qian.gif width=97 height=189 border=0></a><br>
...
次
                ...
                <?php else: ?>
                    <br><br>
                    <a href="?m=3&sm=1&act=ok" title="首先请您心无杂念，然后点这里开始抽签"><img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/qian.gif" width="97" height="189" border="0" /></a>
                    <br />
                ...
                <?php endif; ?></td>
                <td class="new" align="center">  <img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/gd1.gif" width="160" height="240" border="0" /></td>
                </tr>
