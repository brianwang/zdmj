<?php /* Smarty version 2.6.6, created on 2015-08-07 08:06:27
...
/images/gy/<?php echo $this->_tpl_vars['gyqid']; ?>
.gif">
                <br>
                <hr>
            </td>
        ...
        <tr>
            <td align="center" class="new">
                <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="152" height="240">
                    <param name="movie" value="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/gy.swf" />
                    <param name="quality" value="high" />
                    <embed src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/gy.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="152" height="240">
                    </embed>
                </object>
            </td>
...
次<?php if (( $this->_tpl_vars['gysmile'] == '4' )): ?><br>
                ...
                <a href="?m=3&sm=2&act=ok" title="首先请您心无杂念，然后点这里开始抽签">
                    <img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/qian.gif" width="97" height="189" border="0" />
                </a>
            ...
            <td class="new" align="center">
                <img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/guanyin.jpg" width="145" height="240" border="0" />
            </td>
        </tr>
