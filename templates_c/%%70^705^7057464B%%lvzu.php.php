<?php /* Smarty version 2.6.6, created on 2015-08-07 08:06:25
...
/images/lvzu/<?php echo $this->_tpl_vars['lvzulqid']; ?>
.gif">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="center" class="new">
                    <img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/lvzul.jpg" width="159" height="240">
                </td>
...
次<?php if (( $this->_tpl_vars['gysmile'] == '4' )): ?><br>
                        ...
                        <?php else: ?>
                            ...
                            <a href="?m=3&sm=4&act=ok" title="首先请您心无杂念，然后点这里开始抽签">
                                <img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/yzqian.gif" width="103" height="134" border="0" />
                            </a>
                            <br />
                        ...
                        <td class="new" align="center">
                            <img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/lvzu.jpg" width="159" height="240" border="0" />
                        </td>
                    </tr>
