<?php /* Smarty version 2.6.6, created on 2015-08-11 04:18:02
...
&xz=12">双鱼座</a></span></TD>
  ...
  <?php if (( $this->_tpl_vars['yctype'] == 'today' )): ?>
...
今日运程</td>
  ...
  <tr>
    <td width="17%" rowspan="4" class="new"><img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/xz_<?php echo $this->_tpl_vars['rs']['id']; ?>
...
<br>
    ...
    <td width="24%" class="new"><img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/x_<?php echo $this->_tpl_vars['rs']['aqys']; ?>
.gif"></td>
    <td width="14%" bgcolor="e7e7e7" class="new">综合运势:</td>
    <td width="15%" class="new"><img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/x_<?php echo $this->_tpl_vars['rs']['zhys']; ?>
.gif"></td>
  </tr>
  <tr>
    <td bgcolor="e7e7e7" class="new">工作状况:</td>
    <td class="new"><img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/x_<?php echo $this->_tpl_vars['rs']['gzzk']; ?>
.gif"></td>
    <td bgcolor="e7e7e7" class="new">理财投资:</td>
    <td class="new"><img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/x_<?php echo $this->_tpl_vars['rs']['nctz']; ?>
.gif"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="new">
      <table width="100%" border="0">
        <tr>
          <td width="16%"><img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/xz_<?php echo $this->_tpl_vars['rs']['id']; ?>
...
(<?php echo $this->_tpl_vars['rs']['yxqx']; ?>
  ...
  <tr>
    <td class="new"><strong>整体运势</strong>:<img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/x_<?php echo $this->_tpl_vars['rs']['ztzs']; ?>
.gif"><BR>
  ...
  <tr>
    <td class="new"><strong>爱情运势</strong>:<br>
      有对象:<img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/x_<?php echo $this->_tpl_vars['rs']['aqzs1']; ?>
.gif"><BR>
      <?php echo $this->_tpl_vars['rs']['aqys1']; ?>
<br>
      没对象:<img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/x_<?php echo $this->_tpl_vars['rs']['aqzs2']; ?>
.gif"><BR>
  ...
  <tr>
    <td class="new"><strong>健康运势</strong>:<img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/x_<?php echo $this->_tpl_vars['rs']['jkzs']; ?>
.gif"><BR>
  ...
  <tr>
    <td class="new"><strong>工作学业运</strong>:<img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/x_<?php echo $this->_tpl_vars['rs']['gzzs']; ?>
.gif"><BR>
  ...
  <tr>
    <td class="new"><strong>性欲指数</strong>:<img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/x_<?php echo $this->_tpl_vars['rs']['xyzs']; ?>
.gif"><BR>
...
.gif"><BR>
  ...
  <tr>
    <td class="new"><strong>爱情运势</strong>:<img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/x_<?php echo $this->_tpl_vars['rs']['aqzs']; ?>
.gif"><BR>
  ...
  <tr>
    <td class="new"><strong>投资理财运</strong>:<img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/x_<?php echo $this->_tpl_vars['rs']['tzzs']; ?>
.gif"><BR>
...
(<?php echo $this->_tpl_vars['rs']['yxqx']; ?>
    ...
    <tr>
      <td class="new"><strong>整体概况</strong>:<img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/x_<?php echo $this->_tpl_vars['rs']['ztzs']; ?>
.gif"><br>
    ...
    <tr>
      <td class="new"><strong>功课学业</strong>:<img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/x_<?php echo $this->_tpl_vars['rs']['gkzs']; ?>
.gif"><br>
    ...
    <tr>
      <td class="new"><strong>工作职场</strong>:<img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/x_<?php echo $this->_tpl_vars['rs']['gzzs']; ?>
.gif"><br>
    ...
    <tr>
      <td class="new"><strong>金钱理财</strong>:<img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/x_<?php echo $this->_tpl_vars['rs']['jqzs']; ?>
.gif"><br>
    ...
    <tr>
      <td class="new"><strong>恋爱婚姻</strong>:<img src="<?php echo $this->_tpl_vars['siteTheme']; ?>
/images/x_<?php echo $this->_tpl_vars['rs']['lazs']; ?>
.gif"><br>
